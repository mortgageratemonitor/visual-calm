...
A browser-based generative visual experience designed for relaxation and focus. Six immersive modes run entirely in your browser with no backend, no login, and no time limit — safe to leave running for hours.
